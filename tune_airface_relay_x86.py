...
batch_size = 1
dtype = "float32"
model_name = "face_partial"
log_file = "%s.log" % model_name
graph_opt_sch_file = "%s_graph_opt.log" % model_name
model_dir = './%s.onnx' % model_name
lib_dir = './%s_tune_lib.tar' % model_name
graph_dir = './%s_tune_graph.json' % model_name
params_dir = './%s_tune_params' % model_name
